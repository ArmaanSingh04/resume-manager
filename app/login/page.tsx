...
import { ArrowRight, Link2, BarChart2, Zap, FileText } from "lucide-react";
...
export default function Login() {
    ...
    const perks = [
        { icon: Link2, text: "One permanent link for all your resume versions" },
        { icon: BarChart2, text: "Real-time recruiter visit tracking" },
        { icon: Zap, text: "Instant resume swap — no link change needed" },
        { icon: FileText, text: "AI-powered resume feedback" },
    ];
                ...
                <div className="auth-card-wrap">
                    ...
                    <div className="auth-card">
                        ...
                        <p className="auth-subtitle">
                            Sign in to access your dashboard, manage resumes, and track recruiter visits in real time.
                        </p>
